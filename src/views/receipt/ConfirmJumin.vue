        ...
        <div class="wrap">
            ...
            <div class="header">
                ...
                <div class="header_title">
                    <div class="header_title_down">주민정보 확인</div>    
                </div>
                <div class="back"  v-on:click="goBack"></div>    
            </div>

            <!-- ======== 내용 ======== -->
            <div class="confirmjumin_container">
                <div class="confirmjumin_area">
                </div>
                <div class="confirmjumin_ment">
                </div>
            </div><!--container끝-->
...
<script>
import '@/assets/css/receipt/confirmjumin.css';
...
export default {
    ...
    methods: {
        ...
        goReceiptSign(){
            ...
            this.log_data.actionData = '주민정보 확인';
            // 로그처리
